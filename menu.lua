...
local menu_elements_jmrz =
{
    ...
    -- New Master Toggle for Cursor Teleport
    enable_cursor_teleport = checkbox:new(false, get_hash(my_utility.plugin_label .. "main_enable_cursor_teleport")),
    ...
    -- Target weights (for target prioritization within valid clusters)
